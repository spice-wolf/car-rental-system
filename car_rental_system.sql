...
CREATE TABLE `car`  (
                        `id` int(18) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
                        ...
                        `rent_type` tinyint(1) UNSIGNED NOT NULL COMMENT '汽车的出租类型：0-小时，1-天',
                        `rent` double(13, 0) UNSIGNED NOT NULL COMMENT '汽车的租金，单位是元',
...
CREATE TABLE `history`  (
                            `id` int(18) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
                            `car_id` int(18) UNSIGNED NOT NULL COMMENT '汽车的id',
                            `user_id` int(18) UNSIGNED NOT NULL COMMENT '用户的id',
                            `date` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '记录的时间',
                            `type` tinyint(1) UNSIGNED NOT NULL COMMENT ' 类型：0-出租，1-归还',
                            PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user_role`  (
                              `id` int(18) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
                              `user_id` int(18) UNSIGNED NOT NULL COMMENT '用户id',
